...
const Login = () => {
    return (
        <div className='text-white container mx-auto py-14'>
            <h1 className='text-center text-3xl font-bold'>Login To get Your Fans Support You</h1>
            ...
            <div className=' flex justify-center'>
                <div className="flex flex-col gap-2 min-h-screen  p-10 ">
                    ...
                    <button
                        className="flex items-center   border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-blue-950 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center   border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-blue-950  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2 bg-white rounded-full p-1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
